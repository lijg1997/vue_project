<template>
    <div class="msite_shop_list border-1px">
        ...
        <div class="shop_container" ref="shopScroll">
            <ul class="shop_list">
                <li class="shop_li border-1px" v-for="(shop, index) in shops" :key="index">
                    <a>
                        <div class="shop_left" @click="$router.replace(`/shop/${shop.id}`)">
                        ...
                        <div class="shop_right">
                            ...
                            <section class="shop_rating_order">
                                <section class="shop_rating_order_left">
                                    <EleStar class="star" :size="24" :score="shop.rating" :MR="2"></EleStar>
...
<script>
    ...
    export default {
        name: "shopList",
        computed:{
            ...mapState(['shops', 'imgBaseUrl', 'user'])
        },
        methods:{
            ...mapActions([GETSHOPS]),
            renderScroll(){
